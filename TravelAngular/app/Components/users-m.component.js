...
var UsersMComponent = (function () {
    function UsersMComponent(fb, _userService) {
        this.fb = fb;
    ...
    UsersMComponent.prototype.SetControlsState = function (isEnable) {
    ...
    UsersMComponent.prototype.editUser = function (id) {
    ...
    UsersMComponent.prototype.deleteUser = function (id) {
    ...
    UsersMComponent.prototype.onSubmit = function (formData) {
        var _this = this;
        this.msg = "";
        switch (this.dbops) {
...
], UsersMComponent.prototype, "modal", void 0);
UsersMComponent = __decorate([
    core_1.Component({
        templateUrl: 'app/Components/Templates/users-m.component.html'
    }),
    __metadata("design:paramtypes", [forms_1.FormBuilder, user_service_1.UserService])
], UsersMComponent);
exports.UsersMComponent = UsersMComponent;
//# sourceMappingURL=users-m.component.js.map