...
var TravelsMComponent = (function () {
    function TravelsMComponent(fb, _travelService) {
        this.fb = fb;
    ...
    TravelsMComponent.prototype.LoadUsers = function () {
        ...
        this._travelService.get(global_1.Global.BASE_USER_ENDPOINT)
...
TravelsMComponent = __decorate([
    core_1.Component({
        templateUrl: './Templates/travels-m.component.html'
    }),
...
//# sourceMappingURL=travels-m.component.js.map